...
/* Definitions for SemaphoreToglD3 */
osThreadId_t SemaphoreToglD3Handle;
const osThreadAttr_t SemaphoreToglD3_attributes = {
  .name = "SemaphoreToglD3",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityBelowNormal7,
};
/* Definitions for Mutex_Null */
osThreadId_t Mutex_NullHandle;
const osThreadAttr_t Mutex_Null_attributes = {
  .name = "Mutex_Null",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
void Mutex_Null_Task(void *argument);
...
int main(void)
{
  ...
  /* creation of SemaphoreToglD3 */
  SemaphoreToglD3Handle = osThreadNew(Semaphore_Toggle_D3, NULL, &SemaphoreToglD3_attributes);

  /* creation of Mutex_Null */
  Mutex_NullHandle = osThreadNew(Mutex_Null_Task, NULL, &Mutex_Null_attributes);
...
/**
* @brief Function implementing the SemaphoreToglD3 thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_Mutex_Null_Task */
/**
* @brief Function implementing the Mutex_Null thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Mutex_Null_Task */
void Mutex_Null_Task(void *argument)
{
  /* USER CODE BEGIN Mutex_Null_Task */
  /* Infinite loop */
	for(;;)
	{
